...
const STRINGS: Record<AppLanguage, StringTable> = {
    en: {
        ...
        simpleNumbersDescription: 'Instead of numbers like 337 and 387 show 37 and 87. Since most bus numbers are 3xx, two-digit numbers can be easier to discern and to remember',
        ...
        stopNotOperatingCurrently: 'This stop is not operating currently',
        notOperating: 'Not operating',
        metroEntranceOpenHours: 'Entrance open {0} – {1}',
        ...
        everyMinutesLastTrainAt: 'every {0}\', last at\u00A0{1}',
        ...
        loopRouteLiveDataWarning: 'Live data from TTC shows arrivals in both directions as the same. Be careful not to take the bus in the opposite direction.',
    ...
    ka: {
        ...
        simpleNumbersDescription: '337 და 387-ის ნაცვლად გამოჩნდება 37 და 87. რადგან ავტობუსების ნომრების უმეტესობა 3xx-ია, ორნიშნა ნომრები უფრო მარტივად გასარჩევი და დასამახსოვრებელია',
        ...
        stopNotOperatingCurrently: 'ეს გაჩერება ამჟამად არ ფუნქციონირებს',
        notOperating: 'არ ფუნქციონირებს',
        metroEntranceOpenHours: 'შესასვლელი ღიაა {0} – {1}',
        ...
        everyMinutesLastTrainAt: 'ყოველ {0}\', ბოლო {1}-ზე',
        ...
        loopRouteLiveDataWarning: 'TTC-ის ცოცხალი მონაცემები ორივე მიმართულების ჩამოსვლას ერთნაირად აჩვენებს. ფრთხილად იყავით, საპირისპირო მიმართულებით მიმავალ ავტობუსში არ ჩაჯდეთ.',
    ...
    ru: {
        ...
        simpleNumbersDescription: 'Вместо номеров 337 и 387 показывать 37 и 87. Поскольку большинство автобусных номеров начинается с 3, такое сокращение может помочь отличить их друг от друга',
        ...
        stopNotOperatingCurrently: 'Эта остановка в настоящее время не работает',
        notOperating: 'Не работает',
        metroEntranceOpenHours: 'Вход открыт {0} – {1}',
        ...
        everyMinutesLastTrainAt: 'каждые {0}\', последний в\u00A0{1}',
        ...
        loopRouteLiveDataWarning: 'Данные TTC показывают прибытия в обоих направлениях одинаково. Будьте внимательны, чтобы не сесть в автобус в противоположном направлении.',
...
export function applyStaticText() {
    ...
    setText('menu-simple-numbers-description', t('simpleNumbersDescription'));
